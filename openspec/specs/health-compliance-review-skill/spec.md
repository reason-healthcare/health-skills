...
Defines the `health-compliance-review` curated skill as a report-only healthcare regulatory review that selects jurisdiction-aware overlays from repository evidence and confirmed context before evaluating control areas.
